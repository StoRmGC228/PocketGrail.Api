...
namespace PocketGrail.DataAccess.Migrations
{
    ...
    [Migration("20260518212608_FixClassFeatureGainingLevelColumn")]
    partial class FixClassFeatureGainingLevelColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassStartingItemChoicePairOptionA", b =>
                {
                    b.Property<int>("ClassStartingItemChoicePairId")
                        .HasColumnType("integer");

                    b.Property<int>("OptionAId")
                        .HasColumnType("integer");

                    b.HasKey("ClassStartingItemChoicePairId", "OptionAId");

                    b.HasIndex("OptionAId");

                    b.ToTable("ClassStartingItemChoicePairOptionA");
                });

            modelBuilder.Entity("ClassStartingItemChoicePairOptionB", b =>
                {
                    b.Property<int>("ClassStartingItemChoicePair1Id")
                        .HasColumnType("integer");

                    b.Property<int>("OptionBId")
                        .HasColumnType("integer");

                    b.HasKey("ClassStartingItemChoicePair1Id", "OptionBId");

                    b.HasIndex("OptionBId");

                    b.ToTable("ClassStartingItemChoicePairOptionB");
                });
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartSkillProficiency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ClassStartSkillProficiencies");
                });

            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemChoicePair", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ClassStartingItemSetId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClassStartingItemSetId");

                    b.ToTable("ClassStartingItemChoicePairs");
                });

            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ClassStartingItemSets");
                });
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.Race", b =>
                {
                    ...
                    b.Property<List<int>>("FlexBonusSlots")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("SubclassFeatureArmorGrants", b =>
                {
                    b.Property<int>("ArmorGrantsId")
                        .HasColumnType("integer");

                    b.Property<int>("SubclassFeatureId")
                        .HasColumnType("integer");

                    b.HasKey("ArmorGrantsId", "SubclassFeatureId");

                    b.HasIndex("SubclassFeatureId");

                    b.ToTable("SubclassFeatureArmorGrants");
                });

            modelBuilder.Entity("SubclassFeatureInstrumentGrants", b =>
                {
                    b.Property<int>("InstrumentGrantsId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("InstrumentGrantsId", "SubclassFeatureId");

                    b.HasIndex("SubclassFeatureId");

                    b.ToTable("SubclassFeatureInstrumentGrants");
                });

            modelBuilder.Entity("SubclassFeatureLanguageGrants", b =>
                {
                    b.Property<int>("LanguageGrantsId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("LanguageGrantsId", "SubclassFeatureId");

                    b.HasIndex("SubclassFeatureId");

                    b.ToTable("SubclassFeatureLanguageGrants");
                });

            modelBuilder.Entity("SubclassFeatureWeaponGrants", b =>
                {
                    b.Property<int>("SubclassFeatureId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("SubclassFeatureId", "WeaponGrantsId");

                    b.HasIndex("WeaponGrantsId");

                    b.ToTable("SubclassFeatureWeaponGrants");
                });
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassFeature", b =>
                {
                    ...
                    b.ToTable("Features", t =>
                        {
                            t.Property("GainingLevel")
                                .HasColumnName("ClassFeature_GainingLevel");
                        });

                    b.HasDiscriminator().HasValue("ClassFeature");
                });

            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.SubclassFeature", b =>
                {
                    b.HasBaseType("PocketGrail.Domain.Entities.Feature");
            ...
            modelBuilder.Entity("ClassStartingItemChoicePairOptionA", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemChoicePair", null)
                        .WithMany()
                        .HasForeignKey("ClassStartingItemChoicePairId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PocketGrail.Domain.Entities.Characters.Item", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ClassStartingItemChoicePairOptionB", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemChoicePair", null)
                        .WithMany()
                        .HasForeignKey("ClassStartingItemChoicePair1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartSkillProficiency", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.Class", "Class")
                        .WithMany("AvailableSkillChoices")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemChoicePair", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemSet", "Set")
                        .WithMany("ChoicePairs")
                        .HasForeignKey("ClassStartingItemSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemSet", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.Class", "Class")
                        .WithOne("StartingItemSet")
                        .HasForeignKey("PocketGrail.Domain.Entities.ClassEntities.ClassStartingItemSet", "ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SubclassFeatureArmorGrants", b =>
                {
                    ...
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.SubclassFeature", null)
                        .WithMany()
                        .HasForeignKey("SubclassFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.SubclassFeature", b =>
                {
                    b.HasOne("PocketGrail.Domain.Entities.ClassEntities.Subclass", "SourceSubclass")
                        .WithMany("SubclassFeatures")
                        .HasForeignKey("SubclassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SourceSubclass");
                });
            ...
            modelBuilder.Entity("PocketGrail.Domain.Entities.ClassEntities.Class", b =>
                {
                    b.Navigation("AvailableSkillChoices");
